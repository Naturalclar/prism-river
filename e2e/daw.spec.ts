...
import { FIXTURE_DIR, makeGarbage, makeTone, makeToneMp3, makeToneOgg } from "./fixture";
...
/* #22: decodeAudioData の対応形式。テスト時にその場生成できる形式を Chromium で実測する。
   m4a / flac は権利フリーの生成手段がここに無いので、実機と手持ち音源で埋める（README の対応表参照）。 */
